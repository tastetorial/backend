...
const saved_1 = require("../controllers/saved");
const category_1 = require("../controllers/category");
const profile_1 = require("../controllers/profile");
router.post('/auth/register', auth_1.register);
router.post("/auth/activate", auth_1.activateAccount);
...
router.post('/update-profile', (0, allowRoles_1.allowRoles)('*'), profile_1.editProfile);
router.get('/profiles', profile_1.getUsers);
router.get('/profiles/:userId', profile_1.getUserProfile);
// router.get('/profiles/details/:userId', getUserDetails);
router.delete('/profiles', profile_1.deleteProfile);
...
router.post('/toggle-follow/:followingId', follow_1.toggleFollow);
...
router.post('/toggle-save/:videoId', saved_1.toggleSaveVideo);
router.get('/get-saved', saved_1.getMySavedVideos);
router.get('/is-saved/:videoId', saved_1.isSavedVideo);
router.get('/categories', category_1.getCategories);
router.post('/categories', (0, allowRoles_1.allowRoles)(enum_1.UserRole.ADMIN), category_1.createCategory);
router.put('/categories/:id', (0, allowRoles_1.allowRoles)(enum_1.UserRole.ADMIN), category_1.updateCategory);
router.delete('/categories/:id', (0, allowRoles_1.allowRoles)(enum_1.UserRole.ADMIN), category_1.deleteCategory);
